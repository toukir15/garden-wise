...
router.post('/', multer_config_1.multerUpload.array('file'), 
// validateRequest(AuthValidation.registerValidationSchema),
post_controller_1.PostControllers.createPost);
router.post('/comment/:postId', post_controller_1.PostControllers.createComment);
router.post('/comment/reply/:commentId', post_controller_1.PostControllers.createCommentReply);
