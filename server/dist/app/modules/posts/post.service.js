...
const createPostIntoDB = (payload, postImages) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const createVotes = yield vote_model_1.Vote.create({})
    const postData = {
      post: Object.assign(Object.assign({}, payload), {
...
const createCommentIntoDB = (payload, postId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const createCommentReplyIntoDB = (payload, commentId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateUpvoteIntoDB = (userId, voteId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findVote.upvote.includes(findUser?._id)) {
      ...
      if (findVote.downvote.includes(findUser?._id)) {
        yield vote_model_1.Vote.findByIdAndUpdate(
          voteId,
          {
      ...
      result = yield vote_model_1.Vote.findByIdAndUpdate(
        voteId,
        {
...
const updateDownvoteIntoDB = (userId, voteId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // check user exist or not
    const findUser = yield user_model_1.User.findById(userId)
    if (!findUser) {
