...
const updateMyProfile = (userId, data, profilePhoto) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const profile = yield user_model_1.User.findById(userId)
    if (!profile) {
      throw new AppError_1.default(
        http_status_1.default.NOT_FOUND,
        'User profile does not exixts!',
      )
    }
    if (profilePhoto) {
    ...
    return yield user_model_1.User.findByIdAndUpdate(userId, data, {
      new: true,
    })
  })
const myFollowings = userId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_model_1.User.findById(findUser?._id)
      .select({ connection: 1 })
      .populate({
        path: 'connection',
        select: { followings: 1 },
